"""
Django settings for some_app_1 project.
...
WSGI_APPLICATION = 'some_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "some_app_1 API",
    "DESCRIPTION": "API documentation for some_app_1 App",
    "VERSION": "v1",
}
